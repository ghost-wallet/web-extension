...
const TokenListItem: React.FC<TokenListItemProps> = ({
  ...
  return (
    <div className="flex items-center justify-between w-full p-3 bg-darkmuted hover:bg-slightmuted transition-colors rounded-lg">
        ...
        <div className="ml-4">
          ...
          <div className="text-base text-mutedtext font-lato">
            {isKaspa
              ...
              : `${formatBalanceWithAbbreviation(parseFloat(formatBalance(token.balance, token.dec)))} ${token.tick}`}
          </div>
        </div>
      </div>
