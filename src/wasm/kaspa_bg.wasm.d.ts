...
export function __wbg_transactionsigninghashecdsa_free(
  a: number,
  b: number,
): void
...
export function pendingtransaction_createInputSignature(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function __wbg_transactionrecordnotification_free(
  a: number,
  b: number,
): void
...
export function pskt_setSequence(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function __wbg_set_nodedescriptor_uid(
  a: number,
  b: number,
  c: number,
): void
...
export function rpcclient_getFeeEstimateExperimental(
  a: number,
  b: number,
): number
...
export function rpcclient_submitTransactionReplacement(
  a: number,
  b: number,
): number
...
export function __wbindgen_export_1(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function __wbindgen_export_6(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function __wbindgen_export_11(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function __wbindgen_export_18(
  a: number,
  b: number,
  c: number,
  d: number,
